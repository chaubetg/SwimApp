...
const CACHE = 'split-compass-v39';
const CORE = ['./index.html', './coach.html', './swimmer.html', './manifest.webmanifest', './manifest-swimmer.webmanifest', './icon-192.png', './icon-512.png'];
